            ...
            <div class="card-deck ml-2 pt-3">
                <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Berisi data - data user yang telah diolah</p>
                    </div>
                    <div class="card-footer">
                        <a href="admin/user_data" class="text-white">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>

                <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                    <div class="card-body">
                        <h1 class="card-title">Data Quiz</h1>
                        <p class="card-text">Berisi data - data quiz</p>
                    </div>
                    <div class="card-footer">
                        <a href="admin/dataQuiz" class="text-white">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
