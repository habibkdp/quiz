        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid">
                <div class="bg-white rounded" style="padding-left:20px; padding-right:20px; padding-bottom:20px;">
                    <a href="<?= base_url('admin/insertQuiz') ?>" class="btn btn-primary" style="margin-top : 50px; margin-bottom : 20px"><strong>+ Tambah data</strong></a>
                        ...
                        foreach ($dataQuiz as $row) : ?>
                            <tbody class="border-dark">
                                <tr>
                                    ...
                                    <td><?= $row['level'] ?></td>
                                    <td>
                                        <a href="<?= base_url("admin/editQuiz/"); ?><?= $row['id'] ?>" class="btn btn-outline-success btn-sm">Edit</a> |
                                        <a href="<?= base_url("admin/deleteQuiz/"); ?><?= $row['id'] ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php endforeach; ?>
