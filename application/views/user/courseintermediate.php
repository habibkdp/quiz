    ...
    <div class="container">
        <div class="bg-white" style="padding:30px;">
            ...
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>1. HTML Intermediate</h5>
                <p>Berisi quiz dengan pertanyaan yang tidak terlalu mudah dan tidak terlalu sulit<a class="btn float-right" href="https://forms.gle/zjrGZRG1dWvn7wSKA">Mulai Quiz</a></p>
            </div>
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>2. PHP Intermediate</h5>
