  ...
  <section class="section" style="margin: 100px;">
    <div class="container">
        <div class="bg-white" style="padding:30px;">
            <h3>COURSE BEGINNER</h3>    
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>1. HTML Beginner</h5>
                <p>Berisi quiz dengan perntanyaan yang mudah<a class="btn float-right" href="https://forms.gle/83MpGg8BYjeLp62s5">Mulai Quiz</a></p>
            </div>
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>2. PHP Beginner</h5>
                <p>Berisi quiz dengan perntanyaan yang mudah<a class="btn float-right" href="https://forms.gle/6WDYNESTG4kkrNGw9">Mulai Quiz</a></p>
            </div>
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>3. PYTHON Beginner</h5>
