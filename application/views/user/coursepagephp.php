    ...
    <div class="container">
        <div class="bg-white" style="padding:30px;">
            ...
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>1. Beginner</h5>
                <p>Berisi quiz dengan perntanyaan yang mudah <a class="btn float-right" href="<?= base_url('user/quiz?course=php&level=beginner')?>">Mulai Quiz</a></p>
            </div>
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>2. Intermediet</h5>
                <p>Berisi quiz dengan pertanyaan yang tidak terlalu mudah dan tidak terlalu sulit<a class="btn float-right" href="https://forms.gle/EbGGR8yGaTg4R94g9">Mulai Quiz</a></p>
            </div>
            <div class="bg-dark rounded-lg" style="color:white; padding:50px; margin-top:30px;">
                <h5>3. Advance</h5>
                <p>Berisi quiz dengan pertanyaan yang sulit<a class="btn float-right" href="https://forms.gle/MJeSFXHvXQD6qF4a6">Mulai Quiz</a></p>
            </div>
        </div>
    </div>
  </section>
